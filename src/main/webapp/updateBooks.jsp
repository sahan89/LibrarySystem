            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group" style="width: 50%">
                        <form:form action="" commandName="updateBook" method="post">
                            <table>
                                ...
                                <tr>
                                    <td></td>
                                    <td><input type="submit" value="Update" name="submit" id="submit"
                                               class="btn btn-primary btn-block pull-right"></td>
                                </tr>
                            </table>
                        </form:form>
                    </div>
